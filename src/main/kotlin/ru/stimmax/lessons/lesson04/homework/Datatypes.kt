...
val v19: Float = 5.75f
//val v20 = `1.414`
// должны отсутствовать кавычки для типа Double (н-р val v20: Double = 1.414)
...
//val v32: String = “🤯”
// используется недопустисый символ в кавычках
val v33: Map<String, Int> = mapOf("true" to 2, "false" to 34)
//val v34 = ‘65535’
// для типа Int должны отсутствовать кавычки (н-р val v34: Int = 65535)
...
val a3: Map<String, Int> = mapOf("pizza" to 1500, "hamburger" to 500)
// 4. Хранить длину очереди в столовой до миллиардной доли сантиметра.
val a4: Long = 34573952L
...
val a10: Map<String, Int> = mapOf("name" to 3)
...
val a12: List<String> = listOf("theme1", "theme2")